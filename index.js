...
var wordList = ["gather", "game", "helicopter", "india", "crown", "surfing", "eagle", "nature", "blossom", "table", "fireplace", "angels", "heaven", "mathematics", "coding"];
...
//When user enters game, convert "Word Game" text characters to drawings using figlet npm package.
figlet("Word Game", function(err, data) {
    if (err) {
    ...
    console.log(data)
    //Welcome screen text.
    console.log(gameTextColor("Welcome to the Word Game!"));
    console.log(gameTextColor("Theme is... Random."));
    //Game instructions.
    var howToPlay = 
    "==========================================================================================================" + "\r\n" +
    "How to play" + "\r\n" +
...
function checkIfUserWon() {
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU'RE A TRUE WORDGAMER!"));
